...
public class ScreenUtils {
    ...
    public static int getScreenWidth() {
        return BookApplication.getmContext().getResources().getDisplayMetrics().widthPixels;
    }
    ...
    public static int getScreenHeight() {
        return BookApplication.getmContext().getResources().getDisplayMetrics().heightPixels;
    }
    ...
    public static float dpToPx(float dp) {
        return dp * BookApplication.getmContext().getResources().getDisplayMetrics().density;
    }
    ...
    public static float pxToDp(float px) {
        return px / BookApplication.getmContext().getResources().getDisplayMetrics().density;
    }
    ...
    public static float pxToSp(float pxValue) {
        return pxValue / BookApplication.getmContext().getResources().getDisplayMetrics().scaledDensity;
    }
    ...
    public static float spToPx(float spValue) {
        return spValue * BookApplication.getmContext().getResources().getDisplayMetrics().scaledDensity;
    }
    ...
    private int getStatusBarHeight() {
        ...
        try {
            ...
            sbar = BookApplication.getmContext().getResources().getDimensionPixelSize(x);
        } catch (Exception e1) {
            e1.printStackTrace();
        }
        return sbar;
